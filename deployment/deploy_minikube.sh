...
echo -e "${CYAN}================================${NC}"
echo ""
echo -e "${YELLOW}1. Open 3 NEW terminals and run:${NC}"
echo "   Terminal 1: kubectl port-forward service/kafka-cluster-kafka-bootstrap 9092:9092 -n kafka"
echo "   Terminal 2: kubectl port-forward service/minio 9000:9000 -n minio"
echo "   Terminal 3: kubectl port-forward service/minio 9001:9001 -n minio"
echo ""
echo -e "${YELLOW}2. Wait 30 seconds for port-forwards to be ready${NC}"
echo ""
echo -e "${YELLOW}3. Run the producer:${NC}"
echo "   python ingestion_layer/producer.py"
echo ""
echo -e "${YELLOW}4. Run the ingestion layer:${NC}"
echo "   python ingestion_layer/minio_ingest_k8s.py"
echo ""
